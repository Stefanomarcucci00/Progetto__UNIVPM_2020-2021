...
import it.univpm.Project.utils.SourceStringSplitter;
/**
 * The class used to download and parse all the data from the API
 * @author Sfefano Marcucci,Alessandro Celani
 *
 */
public class Downloading_and_Parsing {
    /**
 ...
 * @throws IOException
 */
public ArrayList<Tweet> Display_JSONtweets() throws org.apache.tomcat.util.json.ParseException, IOException {
